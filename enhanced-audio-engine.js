...
class EnhancedAudioEngine {
    ...
    noteToMidi(noteName) {
        // Read the name with the shared reader first: the table below cannot
        // see C♭, F♭, E♯, B♯ or a double accidental, and a scale degree it
        // cannot read is a note that never sounds.
