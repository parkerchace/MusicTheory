/**
 * @module ChordAnalyzer
 * @description Advanced chord analysis including container chords and functional harmony
 * @exports class ChordAnalyzer
 * @feature Container chord analysis (chords containing specific notes)
 * @feature Functional harmony grouping (Tonic, Dominant, Predominant)
 * @feature Scale matching with percentage scoring
 * @feature Complexity filtering (triads, sevenths, extended)
 * @feature Interactive chord cards with detailed information
 * @feature Visual grading system (Perfect ★★★, Excellent ★★, Good ★)
 */
