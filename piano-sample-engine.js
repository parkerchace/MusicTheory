...
class PianoSampleEngine {
     ...
     */
    noteToMidi(noteName) {
        // Shared reader first, so C♭/F♭/E♯/B♯ and double accidentals resolve to
        // a real sample instead of silence. The table below still handles this
        // engine's own 'Cs'-style filename spellings.
