 ...
 *
 * Handles scale selection, key selection, and piano visualization
 * Integrates with Music Theory Engine for scale calculations
 *
 * Features:
 * - 60+ scales from multiple musical traditions
 * - 12-key selection
 * - Piano visualizer showing scale degrees
 * - Scale categories and organization
 * - Event system for scale/key changes
 */
