 ...
 * @description Real-time microphone input visualization with multiple modes
 * @exports class AudioVisualizer
 * @feature Real-time microphone input
 * @feature Multiple visualization modes (bars, waves)
 * @feature Fullscreen overlay with gradient effects
 * @feature Web Audio API integration
 * @feature Responsive canvas rendering
 */
